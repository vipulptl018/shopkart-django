...
def add_cart(request, product_id):
    ...
    if current_user.is_authenticated:
        ...
        is_cart_items_exits = CartItem.objects.filter(product = products, user = current_user).exists()
...
def remove_cart_items(request, product_id, cart_item_id):
 ...
 # this fun used for inside card qyantity total value of product total itmes in cards total frand total 
...
# checkout fun same as it is card but only deffent product increment and decrement funcinality remove from ui side and remove button remove from ui side 
